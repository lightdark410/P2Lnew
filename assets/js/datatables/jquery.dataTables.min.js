...
(function(f) {
    ...
    function qa(a, b, c) {
        for (var d = -1, e = 0, h = a.length; e < h; e++) a[e] == b ? d = e : a[e] > b && a[e]--; - 1 != d && c === n && a.splice(d, 1)
    }
    function da(a, b, c, d) {
        var e = a.aoData[b],
            h, g = function(c, d) {
    ...
    function rb(a) {
        ...
        for (var h = a.sDom.split(""), g, k, l, m, p, n, u = 0; u < h.length; u++) {
            ...
            else if (0 !== q.ext.feature.length) for (l = q.ext.feature, n = 0, m = l.length; n < m; n++) if (k == l[n].cFeature) {
                g = l[n].fnInit(a);
                break
            }
        ...
        b = function(b) {
            if (b && b.time) {
                ...
                if (-1 === f.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time < +new Date - 1E3 * g || b.columns && h.length !== b.columns.length))) {
                    ...
                    b.order !== n && (a.aaSorting = [], f.each(b.order, function(b, c) {
    ...
    var db = function(a, b, c, d, e) {
        ...
        else if ("current" == g || "applied" == g) if ("none" == h) c = e.slice();
    ...
    var kc = function(a, b, c) {
        ...
        return db("cell", b, function(b) {
            ...
            if (null === b || b === n || c) {
                m = [];
                p = 0;
                for (q = e.length; p < q; p++) for (k = e[p], u = 0; u < l; u++) t = {
                    row: k,
                    column: u
        ...
        pageButton: {
            ...
            c, d, e, h) {
                var g = a.oClasses,
                    ...
                    l = a.oLanguage.oAria.paginate || {}, m, p, q = 0,
                    t = function(b, d) {
